    ...
    def respond(self,message):
        ...
        if self.Current_State["state"]==0:
            ...
            if message in env.User_Public_messages['start laerning']:
                self.message.append(random.choice(env.Chat_public_messages["let's start learning"]))
            ...
            # if the user is asking about the chat
                ...
                self.message=random.choice(env.Chat_public_messages["What's your name"])+ random.choice(env.Chat_public_messages["what is your purpose"])
